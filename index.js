...
function resetGame() {
    ...
    cells.forEach(cell => {
        // Reset game logic
        cell.status = false;
        cell.holding = cell.mal.id.slice(-1); // "1".."9"
        cell.count = 0;

        // Force clear DOM content (this is the important part)
        while (cell.mal.firstChild) {
            cell.mal.removeChild(cell.mal.firstChild);
        }

        // Optional: remove any leftover classes that might affect appearance
        cell.mal.className = ''; // or cell.mal.classList.remove('some-class')
    });
    ...
    if (middleware[0]) middleware[0].style.display = "none";
}
// Connect button
document.getElementById('btnp')?.addEventListener('click', resetGame);
  ...
  //User starting with two
    ...
    if (two.holding == "X" && two.count == 1) {
        ...
        if (one.holding == "X" && one.count == 2) {
            ...
            if (four.holding == "X" && four.count == 3) {
                proces(current, seven);
                if ((five.holding == "X" || six.holding == "X") && (five.count == 3 || six.count == 3)) {
            ...
            if (five.holding == "X" && five.count == 3) {
                ...
                if ((four.holding == "X" || six.holding == "X") && (four.count == 3 || six.count == 3)) {
            ...
            if (six.holding == "X" && six.count == 3) {
                proces(current, nine);
                if ((four.holding == "X" || five.holding == "X") && (four.count == 3 || five.count == 3)) {
        ...
        if (three.holding == "X" && three.count == 2) {
            ...
            if (six.holding == "X" && six.count == 3) {
                proces(current, nine);
                if ((five.holding == "X" || four.holding == "X") && (five.count == 3 || four.count == 3)) {
            ...
            if (five.holding == "X" && five.count == 3) {
                ...
                if ((six.holding == "X" || four.holding == "X") && (six.count == 3 || four.count == 3)) {
            ...
            if (four.holding == "X" && four.count == 3) {
                proces(current, seven);
                if ((six.holding == "X" || five.holding == "X") && (six.count == 3 || five.count == 3)) {
        ...
        if (four.holding == "X" && four.count == 2) {
            ...
            if ((five.holding == "X" || three.holding == "X" || one.holding == "X" || six.holding == "X") && (five.count == 4 || three.count == 4 || one.count == 4 || six.count == 4)) {
                proces(current, nine);

                if ((one.holding == "X" || six.holding == "X") && (one.count == 4 || six.count == 4)) {
                    proces(current, three);
                }
                if (three.holding == "X" && three.count == 4) {
                    proces(current, six);
        ...
        if (six.holding == "X" && six.count == 2) {
            ...
            if ((five.holding == "X" || one.holding == "X" || three.holding == "X" || four.holding == "X") && (five.count == 4 || one.count == 4 || three.count == 4 || four.count == 4)) {
                proces(current, seven);

                if ((three.holding == "X" || four.holding == "X") && (three.count == 4 || four.count == 4)) {
                    proces(current, one);
                }
                if (one.holding == "X" && one.count == 4) {
                    proces(current, four);
        ...
        if (seven.holding == "X" && Seven.count == 2) {
            ...
            if ((six.holding == "X" || Nine.holding == "X") && (six.count == 3 || Nine.count == 3)) {
                ...
                if ((four.holding == "X" || six.holding == "X") && (one.count == 4 || six.count == 4)) {
                    proces(current, one);
                }
